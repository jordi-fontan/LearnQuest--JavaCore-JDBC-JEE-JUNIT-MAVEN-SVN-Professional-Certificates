...
public class SchoolDAO {
	...
	public void updateStudentBirthDateById(int id, String date) {
		try (Statement stmt = conn.createStatement()){
			String query = "update admissions set dob={d '"+date+"'} where id="+id;
			stmt.executeUpdate(query);
		}
		catch(SQLException e) {
			System.out.println("SQL Exception in SchoolDAO() updateStudentBirthDateById " + e.getMessage());
		}
	}
