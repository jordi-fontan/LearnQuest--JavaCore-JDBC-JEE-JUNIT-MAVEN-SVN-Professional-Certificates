...
public class SchoolDatabase {
	...
	public void getDatabaseMetaData() {
		try {
			...
			System.out.println("SQLException in SchoolDatabase.getDatabaseMetaData "+ e.getMessage());
		}
	}
		
	public void getTableMetaDataByTableName(String tableName) {
		try {
			...
			while(columns.next()) {
				...
				System.out.println(columnName + " -- "+dataType+" -- "+columnSize
						+" -- "+ decimalDigits+" -- " + isNullable+" -- "+ isAutoIncrement);
			}
		}
		catch(SQLException e) {
			System.out.println("SQLException in SchoolDatabase.getTableMetaDataByTableName: "+ e.getMessage());	
		}
		System.out.println(tableName+" metadata fetched.");
	}
}
